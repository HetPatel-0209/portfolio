      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative">
              <div className="w-60 h-60 md:w-80 md:h-80 mx-auto bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center">
                <div className="w-52 h-52 md:w-72 md:h-72 bg-[#f9fafb] rounded-full flex items-center justify-center">
                  <>
                    {
        ...
        >
          <div className="text-center mb-10">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">My Journey in Numbers</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <motion.button 
              ...
              className="group"
            >
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 md:p-8 border border-gray-100 hover:border-green-200">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <div className="text-center">
                    <h4 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">Projects</h4>
                    <p className="text-sm md:text-base text-gray-600">Completed & Deployed</p>
                  </div>
                </div>
              </div>
            </motion.button>
            ...
            <motion.button 
              ...
              className="group"
            >
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 md:p-8 border border-gray-100 hover:border-blue-200">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <div className="text-center">
                    <h4 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">Certifications</h4>
                    <p className="text-sm md:text-base text-gray-600">Professional & Technical</p>
                  </div>
                </div>
              </div>
            </motion.button>
            ...
            >
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 md:p-8 border border-gray-100 hover:border-purple-200">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <div className="text-center">
                    <h4 className="text-lg md:text-xl font-semibold text-gray-900 mb-1">Skills</h4>
                    <p className="text-sm md:text-base text-gray-600">Technologies & Tools</p>
                  </div>
                </div>
              </div>
            </motion.div>
